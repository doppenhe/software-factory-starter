...
6. `docs/harness.md`
7. `docs/runtime.md`
8. `docs/agent-verification.md`
9. `docs/github-coordination.md`
10. `docs/contracts.md` when the task touches a shape more than one writer uses
11. `docs/data-safety.md` when the project holds real data
12. `docs/scheduled-work.md` when the task runs on a schedule
13. `docs/portable-setup.md`
14. `docs/agent-guide.md`
15. `docs/ux-critic.md` when changing visible product UX

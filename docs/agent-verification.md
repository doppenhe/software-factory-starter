...
BLUF: one command decides whether an agent may open a pull request. It must be deterministic, runnable offline, and provably able to fail. A verifier nobody has watched fail is a source of loop delusion, not proof.

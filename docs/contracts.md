...
The contract doc is where L2 lives permanently. It is the answer to "this fact keeps leaking into the spec": give it a contract doc, point the spec at it, and delete the copy. See the spec entropy rules in `CODEX.md`.
